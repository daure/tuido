...
pub(super) enum AppDialog {
    ...
    NoteQuickMenu(Box<NoteQuickMenu>),
...
impl TuiNode<AppMsg> for AppDialog {
    fn measure(&self, proposal: LayoutProposal) -> LayoutSizeHint {
        match self {
            ...
            Self::NoteQuickMenu(menu) => menu.measure(proposal),
    ...
    fn layout(&mut self, area: Rect, ctx: &mut LayoutCtx) -> LayoutResult {
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.layout(area, ctx),
    ...
    fn render<'a>(&'a self, frame: &mut Frame, area: Rect, ctx: &mut RenderCtx<'a>) {
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.render(frame, area, ctx),
    ...
    fn event(&mut self, event: &TuiEvent, ctx: &mut EventCtx<AppMsg>) -> EventOutcome {
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.event(event, ctx),
    ...
    fn dispatch_event(
        ...
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.dispatch_event(route, event, ctx),
    ...
    fn dispatch_focus(&mut self, target: &FocusTarget, focused: bool, ctx: &mut FocusCtx<AppMsg>) {
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.dispatch_focus(target, focused, ctx),
    ...
    fn tick(&mut self, dt: Duration, settings: AnimationSettings) -> TickResult {
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.tick(dt, settings),
    ...
    fn init(&mut self, ctx: &mut LifecycleCtx<AppMsg>) {
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.init(ctx),
    ...
    fn mount(&mut self, ctx: &mut LifecycleCtx<AppMsg>) {
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.mount(ctx),
    ...
    fn unmount(&mut self, ctx: &mut LifecycleCtx<AppMsg>) {
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.unmount(ctx),
    ...
    fn destroy(&mut self, ctx: &mut LifecycleCtx<AppMsg>) {
        match self {
            ...
            Self::NoteQuickMenu(dialog) => dialog.destroy(ctx),
